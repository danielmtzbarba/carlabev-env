...
DESIGNER_LAYOUT_PRESETS = {
    "wide": DesignerLayoutConfig(
        ...
        section_title_gap_base=16,
        param_label_gap_base=12,
        frame_padding_base=22,
        header_gap_base=12,
        option_height_base=28,
        textbox_height_base=36,
        button_height_base=38,
        left_panel_width_max=430,
        left_panel_width_min=330,
        left_panel_floor=310,
        right_panel_width_max=325,
        right_panel_width_min=245,
        right_panel_floor=225,
        center_panel_min_width=420,
        preview_fov_max=210,
