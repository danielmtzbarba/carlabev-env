...
class MapGraph(object):
    ...
    def find_route(self, lane_type='center', max_distance=2000, merge_threshold=10):
        """
        ...
        lane_nodes = [n for n, data in self._G.nodes(data=True) if data.get('lane') == lane_type]
